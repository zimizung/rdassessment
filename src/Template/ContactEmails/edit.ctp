...
<div class="contactEmails form large-9 medium-8 columns content">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <td><?php echo $this->Form->control('email',['label'=>false]);
            //echo $this->Form->control('user_id', ['options' => $users, 'empty' => true]);?>
            </td>
            <td><?php echo$this->Html->link("<<Back"/*$contactEmail->user->name*/, ['controller' => 'Users', 'action' => 'view', $contactEmail->user_id])?></td>
        </tr>
    </table>
